...
import { checkResetTokenApi, resetPasswordApi } from './doctorApiActions';

class DoctorResetPassowrd extends Component {
  constructor(props) {
    super(props);
    this.state = {
      password: '',
                ...
                <div className="col-12 px-0">
                  ...
                  <div className="container-fluid h-100">
                    <div className="row h-100">
                      ...
                      <div className="col-md-7 col-12 bg-wrapper" style={{ backgroundImage: 'url(/assets/img/doctor-5.jpg)' }}>
                      </div>
...
export default DoctorResetPassowrd